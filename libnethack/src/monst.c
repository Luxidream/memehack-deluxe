 ...
 */
    MON("jackal", S_DOG,
        ...
        M3_INFRAVISIBLE | M3_SCENT, CLR_BROWN),
    MON("fox", S_DOG,
        ...
        SIZ(300, 250, 0, MS_BARK, MZ_SMALL), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE,
        M3_INFRAVISIBLE | M3_SCENT, CLR_RED),
    MON("coyote", S_DOG,
        ...
        SIZ(300, 250, 0, MS_BARK, MZ_SMALL), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE,
        M3_INFRAVISIBLE | M3_SCENT, CLR_BLUE),
    ...
    MON("little dog", S_DOG,
        ...
        M3_INFRAVISIBLE | M3_SCENT, HI_DOMESTIC1),
    MON("dog", S_DOG,
        ...
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_DOMESTIC,
        M3_INFRAVISIBLE | M3_SCENT, HI_DOMESTIC2),
    MON("large dog", S_DOG,
        ...
        M2_STRONG | M2_DOMESTIC, M3_INFRAVISIBLE | M3_SCENT, HI_DOMESTIC3),
    MON("dingo", S_DOG,
        LVL(4, 16, 5, 0, 0), (G_GENO | 1),
        A(ATTK(AT_BITE, AD_PHYS, 1, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(400, 200, 0, MS_BARK, MZ_MEDIUM), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE,
        M3_INFRAVISIBLE | M3_SCENT, CLR_YELLOW),
    MON("wolf", S_DOG,
        ...
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE,
        M3_INFRAVISIBLE | M3_SCENT, CLR_GREEN),
    MON("werewolf", S_DOG,
    ...
    MON("warg", S_DOG,
        ...
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE,
        M3_INFRAVISIBLE | M3_SCENT, CLR_BRIGHT_GREEN),
    ...
    MON("winter wolf", S_DOG,
        ...
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE,
        M2_HOSTILE | M2_STRONG, M3_SCENT, CLR_CYAN | HI_ULINE),
    MON("hell hound pup", S_DOG,
        ...
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE,
        M3_INFRAVISIBLE | M3_SCENT, CLR_ORANGE),
    MON("hell hound", S_DOG,
        ...
        M3_INFRAVISIBLE | M3_SCENT, CLR_ORANGE | HI_ULINE),
#ifdef CHARON
    MON("Cerberus", S_DOG,
 ...
 */
    MON("kitten", S_FELINE,
        ...
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE,
        M2_WANDER | M2_DOMESTIC, M3_INFRAVISIBLE | M3_SCENT, HI_DOMESTIC1),
    ...
    MON("lynx", S_FELINE,
        ...
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE,
        M3_INFRAVISIBLE | M3_SCENT, CLR_CYAN),
    MON("panther", S_FELINE,
        ...
        SIZ(600, 300, 0, MS_GROWL, MZ_LARGE), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE,
        M3_INFRAVISIBLE | M3_SCENT, CLR_BLACK),
 ...
 */
    ...
    MON("bugbear", S_HUMANOID,
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION | M3_SCENT, CLR_BROWN),
 ...
 */
    MON("white unicorn", S_UNICORN,
        ...
        M3_INFRAVISIBLE | M3_SCENT, CLR_WHITE),
    MON("gray unicorn", S_UNICORN,
        ...
        SIZ(1300, 300, 0, MS_NEIGH, MZ_LARGE), MR_POISON, MR_POISON,
        M1_NOHANDS | M1_HERBIVORE, M2_WANDER | M2_STRONG | M2_JEWELS,
        M3_INFRAVISIBLE | M3_SCENT, CLR_GRAY),
    ...
    MON("warhorse", S_UNICORN,
        ...
        M1_ANIMAL | M1_NOHANDS | M1_HERBIVORE,
        M2_WANDER | M2_STRONG | M2_DOMESTIC,
        M3_INFRAVISIBLE | M3_SCENT, CLR_RED | HI_ULINE),
/*
 * vortices
 */
 ...
 */
    MON("garter snake", S_SNAKE,
        ...
        | M1_CARNIVORE | M1_NOTAKE, 0, M3_SCENT, CLR_GREEN),
    MON("snake", S_SNAKE,
    ...
    MON("pit viper", S_SNAKE,
        ...
        M1_SWIM | M1_CONCEAL | M1_NOLIMBS | M1_ANIMAL | M1_SLITHY | M1_POIS |
        M1_CARNIVORE | M1_OVIPAROUS | M1_NOTAKE,
        M2_HOSTILE, M3_INFRAVISION | M3_SCENT, CLR_BLUE),
    MON("python", S_SNAKE,
        ...
        M2_HOSTILE | M2_STRONG, M3_INFRAVISION | M3_SCENT, CLR_MAGENTA),
    MON("cobra", S_SNAKE,
        ...
        M1_SWIM | M1_CONCEAL | M1_NOLIMBS | M1_ANIMAL | M1_SLITHY | M1_POIS |
        M1_CARNIVORE | M1_OVIPAROUS | M1_NOTAKE,
        M2_HOSTILE, M3_SCENT, CLR_BRIGHT_BLUE),
/*
 * Trolls
 */
    MON("troll", S_TROLL,
    ...
    MON("ice troll", S_TROLL,
        ...
        M1_HUMANOID | M1_REGEN | M1_CARNIVORE,
        M2_STRONG | M2_STALK | M2_HOSTILE,
        M3_INFRAVISIBLE | M3_INFRAVISION | M3_SCENT, CLR_WHITE),
    MON("rock troll", S_TROLL,
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION | M3_SCENT, CLR_CYAN),
    MON("water troll", S_TROLL,
        ...
        M2_STRONG | M2_STALK | M2_HOSTILE,
        M3_INFRAVISIBLE | M3_INFRAVISION | M3_SCENT, CLR_BLUE),
    MON("Olog-hai", S_TROLL,
        ...
        M1_HUMANOID | M1_REGEN | M1_CARNIVORE,
        M2_STRONG | M2_STALK | M2_HOSTILE | M2_COLLECT,
        M3_INFRAVISIBLE | M3_INFRAVISION | M3_SCENT, HI_LORD),
/*
 * Umber hulk
 */
 ...
 */
    ...
    MON("ape", S_YETI,
        ...
        M1_ANIMAL | M1_HUMANOID | M1_CARNIVORE, M2_STRONG, 0, CLR_RED),
    MON("owlbear", S_YETI,
        ...
        M1_ANIMAL | M1_HUMANOID | M1_CARNIVORE,
        M2_HOSTILE | M2_STRONG | M2_NASTY, M3_INFRAVISIBLE | M3_SCENT,
        CLR_BROWN),
    MON("yeti", S_YETI,
 ...
 */
    MON("water demon", S_DEMON,
        ...
        SIZ(WT_HUMAN, 400, 0, MS_WISHGIVER, MZ_HUMAN), MR_FIRE | MR_POISON, 0,
...
#undef SEDUCTION_ATTACKS
    ...
    MON("djinni", S_DEMON,
        ...
        A(ATTK(AT_WEAP, AD_PHYS, 2, 8),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1500, 400, 0, MS_WISHGIVER, MZ_HUMAN), MR_POISON | MR_STONE, 0,
        M1_HUMANOID | M1_FLY | M1_POIS,
